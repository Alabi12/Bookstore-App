...
```sh
  cd my-folder
  git clone https://github.com/Alabi12/Bookstore-App.git
```
...
- LinkedIn: [@robert-alabi](https://linkedin.com/in/robert-alabi)
...
Feel free to check the [issues page](https://github.com/Alabi12/Bookstore-App/issues)
